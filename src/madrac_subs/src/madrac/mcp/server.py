...
from .tools.recon_characters import register as register_recon_characters
...
def create_server(app_state: dict[str, Any]) -> FastMCP:
    ...
    logger.info("MADRAC MCP server created (25 tools, 4 resources)")
    return mcp
